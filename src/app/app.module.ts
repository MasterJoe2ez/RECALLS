...
import {VoteService} from './main/vote.service';
...
import { UserSettingComponent } from './setup/user-setting/user-setting.component';
import { SetPriceComponent } from './setup/set-price/set-price.component';
import { UserSettingDialogComponent } from './setup/user-setting/user-setting-dialog/user-setting-dialog.component';
import { SetPriceDialogComponent } from './setup/set-price/set-price-dialog/set-price-dialog.component';
import { ChartComponent } from './setup/chart/chart.component';
import { MapDialogComponent } from './setup/user-setting/map-dialog/map-dialog.component';
